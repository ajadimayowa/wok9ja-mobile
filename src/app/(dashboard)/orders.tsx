...
import { Button, TextInput, View, Text, SafeAreaView, ScrollView, Pressable, Animated, KeyboardAvoidingView, Platform, TouchableOpacity, Image, ToastAndroid } from 'react-native';
...
import OrderCard from '@/src/components/cards/order-card';
...
const OrderScreen = () => {
    ...
    const handleOrderSorting = () => {
        ToastAndroid.show('Sorting by date', ToastAndroid.LONG);
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
            title: `Manage orders`, // Custom title
            headerStyle: {
            ...
            headerRight: ({ size, color }: any) => (
                <View style={{ paddingHorizontal: 15 }}><TouchableOpacity onPress={handleOrderSorting}><Ionicons color={'#fff'} size={24} name={'filter-outline'} /></TouchableOpacity></View>
            ),
